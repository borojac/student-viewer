...
public class FilterUtil {
	...
	public static ArrayList<StudentMainTableDTO> filter(MainFormController mainFormController, HashMap<String, HashMap<String, String>> testoviMap, ArrayList<String> controlParams) {
