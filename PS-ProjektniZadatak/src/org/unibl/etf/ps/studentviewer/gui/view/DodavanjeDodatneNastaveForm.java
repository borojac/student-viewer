...
public class DodavanjeDodatneNastaveForm extends JFrame {
	 ...
	 * @param dataModel 
	 */
	public DodavanjeDodatneNastaveForm(ElektrijadaForm forma, JTable tableNastavneTeme, ElektrijadaController kontroler, DodatnaNastavaDataTableModel dodatnaNastavaDataModel) {
		this.forma = forma;
		...
		btnDodaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dodatnaNastavaController.dodajStudentaControl(textFieldNaziv,textFieldDatum,textAreaNapomena,nastavaForm,forma,tableNastavneTeme,kontroler,dodatnaNastavaDataModel);
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnNewButton_1, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE)
						.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
							.addComponent(lblNapomena)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(textAreaNapomena))
						.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(textFieldNaziv, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblNaziv))
					.addGap(28)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblDatum)
