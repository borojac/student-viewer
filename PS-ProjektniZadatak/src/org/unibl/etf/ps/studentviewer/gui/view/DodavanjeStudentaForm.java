...
import org.unibl.etf.ps.studentviewer.logic.controller.DodavanjeStudentaController;
...
public class DodavanjeStudentaForm extends JFrame {
	...
	private DodavanjeStudentaController studentController;
	private DodavanjeStudentaForm dodavanjeForma;
	...
	public DodavanjeStudentaForm(ElektrijadaForm forma, JTable tableStudenti, ElektrijadaController kontroler, StudentiZaElektrijaduTableModel studentiZaElektrijaduDataModel) {
		this.forma = forma;
		dodavanjeForma = this;
		...
		studentController = new DodavanjeStudentaController();
		setResizable(false);	
		...
		btnDodaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				studentController.dodajStudentaControl(dodavanjeForma,forma,tableStudenti,tableStudentiPredmeti,studentiZaElektrijaduDataModel,kontroler);
				}
		});
